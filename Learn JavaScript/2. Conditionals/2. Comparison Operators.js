...
the statement evaluates to false. The code above would be asking: is 10 less than 12? 
...
/* In the example above, we’re using the identity operator (===) to check 
if the string 'apples' is the same as the string 'oranges'. 
