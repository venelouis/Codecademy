...
Set it equal to a Boolean value. You’ll change this later. */
let early = true;
...
log a statement to the console telling them that they will race at 12:30 pm. 
Include their raceNumber. */
else if (age < 18) {
    console.log(`Race will begin at 12:30, your race number is ${raceNumber}.`);
}
/* 8. Enter different combinations of values for the two variables you created 
and run your code several times. Verify that the correct statements are printing to the console!
...
// Watch the solution at: https://www.youtube.com/watch?v=sSnUXjb_u-g&t=1s